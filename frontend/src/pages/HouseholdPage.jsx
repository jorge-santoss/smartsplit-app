      ...
      {activeTab === "Members" && (
        <div className="space-y-6">
          ...
          {(() => {
            ...
            const others =
              household.members?.filter((m) => m.role !== "owner") || [];
            return (
              <>
                {owner && (
                  <div className="bg-white rounded-xl border border-gray-200">
